...
export const Route = createFileRoute("/projects")({
  ...
  head: () => ({
    meta: [
      { title: "Projects — JS:GO" },
      { name: "description", content: "Real builds you can ship." },
    ],
  }),
});
...
function ProjectsPage() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      <span className="chip">
        <Hammer className="h-3 w-3" /> Build to learn
      </span>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        {PROJECTS.map((p) => (
          <article key={p.slug} className="bento bento-hover p-6">
            ...
            <div className="mt-3">
              <div className="text-[10px] font-bold uppercase tracking-wider text-[var(--color-accent-2)]">
                Stretch goals
              </div>
