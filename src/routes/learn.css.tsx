...
export const Route = createFileRoute("/learn/css")({
  component: CssPage,
  head: () => ({ meta: [{ title: "CSS — JS:GO" }, { name: "description", content: "Modern CSS, layout, and motion." }] }),
});

function CssPage() {
  const lessons = lessonsByTrack("css");
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      <h1 className="text-4xl font-black tracking-tight md:text-5xl">CSS</h1>
      <p className="mt-3 text-muted-foreground">Style, layout, and motion for the modern web.</p>
