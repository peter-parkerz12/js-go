  ...
  component: () => (
    <div className="mx-auto max-w-2xl px-4 py-10">
      ...
      <p className="mt-4 text-muted-foreground">
        JS:GO is a focused learning platform for HTML, CSS, and modern JavaScript.
        Every lesson is short, opinionated, and ends with practice. The goal is simple:
        in 60–90 days you should be ready to step into React or Next.js without feeling lost.
      </p>
